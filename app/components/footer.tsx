        ...
        <div id="footer" className="md:mt-[80px] mt-[60px]">
                ...
                <div className="bg-[#E8E8E8] w-[100%] md:h-[424px] h-[340px]">
                    <div className="md:flex">
                        <div>
                            <a href="mailto: hello@tca.com.pk"><div className="flex ml-[48px] pt-[46px]"><img className="md:w-10 w-8" src="email.svg" alt="Email Us" /><p className="ml-[16px] md:text-[24px] text-[20px]">hello@tca.com.pk</p></div></a>
                            <hr className="md:w-80 h-[1px] mx-[48px] my-4 bg-[#5E5E5E] border-0 md:my-6" />
                            <a href="tel:+923052837680"><div className="flex ml-[48px] pt-[10px]"><img className="md:w-10 w-8" src="phone.svg" alt="Call Us" /><p className="ml-[16px] md:text-[24px] text-[20px]">+92 305 2837680</p></div></a>
                            <hr className="md:w-80 h-[1px] mx-[48px] my-4 bg-[#5E5E5E] border-0 md:my-6" />
